...
const OnboardingForm = () => {
  ...
  return (
    <div className="flex flex-col justify-start items-start w-full relative mt-36 font-manrope">
      <div className="text-2xl flex justify-center items-start w-full relative">
        {`Generate a blog for free`}
      </div>
      <div className="flex justify-center items-center p-12 gap-32 relative w-full">
        ...
        <div className="flex flex-col justify-start items-start gap-4">
          ...
          <div className="relative">
            <select
              className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-2xl focus:ring-blue-500 focus:border-blue-500 w-full p-2.5"
              value={industry}
