  ...
  return (
    <>
      ...
      >
        ...
        <Typography
          sx={{ fontSize: "2.5rem", fontWeight: "600", textAlign: "center", m: "2rem" }}
        >
          Privacy Policy
        </Typography>
      </Box>
      ...
      >
        ...
        <TextStyled>
          ...
          <br /> This Privacy Policy outlines how TheHyperBrand (&quot;we&quot;,
          &quot;our&quot;, or &quot;us&quot;) collects, uses, discloses, and
          safeguards the personal information of users (&quot;you&quot; or
          &quot;your&quot;) when you visit and use our website,
          https://thehyperbrand.com/ (&quot;Website&quot;). We are committed to
          protecting your privacy and ensuring the security of your personal
          information. By accessing or using the Website, you consent to the
        ...
        <TextStyled>
          <br />
          a. Personal Information: We may collect personal information from you
          when you visit our Website or register an account with us. This
          information may include but is not limited to: <br />- Your name{" "}
          <br />- Email address <br />- Contact number <br />- Billing address{" "}
          <br />- Payment information <br />- Profile picture <br />-
          Professional expertise and background
          <br />
          <br />
          b. Usage Information: We may also collect non-personal information
          about your use of the Website, including but not limited to:
          <br />- IP address
          <br />- Browser type
          <br />- Operating system
          <br />- Referring URLs
        ...
        <TextStyled>
          ...
          <br />- To enforce our terms and conditions and protect our legal
          rights
        </TextStyled>
        <br />
        <TextStyled sx={{ fontWeight: "600" }}>
        ...
        <TextStyled>
          ...
          <br />- With experts or service providers who are necessary for
          providing the requested services
          <br />- With third-party payment processors to process transactions
          <br />- With third parties for marketing and promotional purposes,
        ...
        <TextStyled>
          ...
          that no data transmission over the internet or electronic storage
          method is 100% secure, and we cannot guarantee its absolute security.
        </TextStyled>
        <br />
        <TextStyled sx={{ fontWeight: "600" }}>
          <br />
        ...
        <TextStyled>
          ...
          experience on our Website, analyze trends, and administer the site.
        ...
        <TextStyled>
          ...
          information by contacting us. You may also unsubscribe from our
        ...
        <TextStyled>
          ...
          be effective upon posting the revised policy on the Website. We
